  ...
  return (
    <div>
      ...
      <div className='home-view'>
        <img className='home-view-photo' src="https://i.postimg.cc/Ss5SPGVD/pisajej-zcar-1-1.png" alt="imágen paisaje de Júzcar" />
        <img className='home-view-photo-responsive' src="https://i.postimg.cc/DZQ8tMRW/Que-ver-en-Juzcar-RESPONSIVE-1-1.png" alt="imágen paisaje de Júzcar" />
        <h1 className='home-view-title'>Colaboradores</h1>
         <div className='colab-section'> 
         <section className='colab-section-img'>
         <img  className='pitufo-dad' src="https://i.postimg.cc/DfsmLqRm/pngwing-com-2.png" alt="ilustración de papá pitufo" />
      ...
      <img className='photo-pitufos'src="https://i.postimg.cc/fW2TtMNY/pngwing-com-1.png" alt="ilustración de todos los pitufos en fila" />
